            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu" id="user_menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="{{ Auth::check() ? $user->avatar : asset('/img/avatar.png') }}" class="user-image"
                             alt="User Image"/>
                        <!-- hidden-xs hides the username on small devices so only the image appears. -->
                        <span class="hidden-xs">{{ Auth::check() ? Auth::user()->name : trans('admin.no_name') }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- The user image in the menu -->
                        <li class="user-header">
                            <img src="{{ Auth::check() ? $user->avatar : asset('/img/avatar.png') }}" class="img-circle"
                                 alt="User Image"/>
                            <p>
                                {{ Auth::check() ? Auth::user()->name : trans('admin.no_name') }}
                                <small>{{ trans('admin.since') }} {{ Auth::check() ? Auth::user()->created_at : '' }}</small>
                            </p>
                        </li>
                        <!-- Menu Footer-->
